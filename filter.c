...
void filterField(Domain *D)
{
    ...
    float alpha[2];
    float nowE1,nowB1,nowPr,nowPl,nowSr,nowSl,nowJ1,nowJ2,nowJ3;
    float beforeE1,beforeB1,beforePr,beforePl,beforeSr,beforeSl,beforeJ1,beforeJ2,beforeJ3;
    float nowE1C,nowB1C,nowPrC,nowPlC,nowSrC,nowSlC,nowJ1Old,nowJ2Old,nowJ3Old;
    float beforeE1C,beforeB1C,beforePrC,beforePlC,beforeSrC,beforeSlC,beforeJ1Old,beforeJ2Old,beforeJ3Old;
    float *filt;
    int myrank,nTasks;  
...
//        nowJ1=field[istart-2][j].J1;
//        nowJ2=field[istart-2][j].J2;
//        nowJ3=field[istart-2][j].J3;
...
//        nowJ1Old=field[istart-2][j].J1Old;
//        nowJ2Old=field[istart-2][j].J2Old;
//        nowJ3Old=field[istart-2][j].J3Old;
...
//            beforeB1C=nowB1C;
            ...
            beforeSrC=nowSrC;
            beforeSlC=nowSlC;
//            beforeJ1Old=nowJ1Old;
//            beforeJ2Old=nowJ2Old;
//            beforeJ3Old=nowJ3Old;
//            nowE1=field[i][j].E1;
//            nowB1=field[i][j].B1;
            nowPr=field[i][j].Pr;
            nowPl=field[i][j].Pl;
...
//            nowJ1Old=field[i][j].J1Old;
//            nowJ2Old=field[i][j].J2Old;
//            nowJ3Old=field[i][j].J3Old;
...
//            field[i][j].J1=alpha[a]*nowJ1+(1.0-alpha[a])*(beforeJ1+field[i+1][j].J1)*0.5;       
//            field[i][j].J2=alpha[a]*nowJ2+(1.0-alpha[a])*(beforeJ2+field[i+1][j].J2)*0.5;       
//            field[i][j].J3=alpha[a]*nowJ3+(1.0-alpha[a])*(beforeJ3+field[i+1][j].J3)*0.5;       
...
//            field[i][j].J1Old=alpha[a]*nowJ1Old+(1.0-alpha[a])*(beforeJ1Old+field[i+1][j].J1Old)*0.5;       
//            field[i][j].J2Old=alpha[a]*nowJ2Old+(1.0-alpha[a])*(beforeJ2Old+field[i+1][j].J2Old)*0.5;       
//            field[i][j].J3Old=alpha[a]*nowJ3Old+(1.0-alpha[a])*(beforeJ3Old+field[i+1][j].J3Old)*0.5;       
          }
        }		//end of for(i)
      }           //end of for(j)
    }
