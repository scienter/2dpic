EXEC = show
CC = mpicc 
OBJS = main.o saveFile.o parameterSetting.o findparam.o boundary.o loadPlasma.o loadLaser.o fieldSolve.o fieldShareY_DSX.o interpolation.o particlePush.o updateCurrent_DSX.o rearrangeParticles.o particleShareY.o removeEdge.o movingDomain.o probe.o dumpData.o clean.o filter.o boostShot.o pml.o
